...
theme_minimal()
```
This plot highlights the 15 counties with the highest fatal police shooting rates between 2017 and 2020. The bar height shows shootings per 100,000 residents, and the fill color shows COVID-19 deaths per 100,000 in 2020. This lets me visually check whether places with high exposure to police violence also experienced high COVID mortality.
