...
influence health outcomes. This project focuses on mapping Covid-19
cases at the county level to better understand these relationships. By
integrating data from The New York Times on county-level Covid-19 cases
with weather, population, and socioeconomic information, we aim to
identify patterns that may have influenced the spread of the virus.
Overall, by studying these relationships we will be able to gain insight
...
across the United States in relation to population density,
socioeconomic, health, and environmental factors. The final products
will include interactive visualizations (maps and dashboards),
statistical summaries, and predictive models exploring correlations
...
1.  Clean, merge, and standardize county-level datasets; calculate
    ...
    trends across U.S. regions.
2.  Model relationships between COVID-19 outcomes and county
